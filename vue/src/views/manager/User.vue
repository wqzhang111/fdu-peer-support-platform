<template>
  <div>
    <div class="search">
      <el-input placeholder="Please enter the account to search" style="width: 200px; margin-right: 10px" v-model="username"></el-input>
    ...
    <div class="table">
      <el-table :data="tableData" strip @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="info" label="Personal Info" show-overflow-tooltip></el-table-column>
        <el-table-column prop="birth" label="Birthday"></el-table-column>
    ...
    <el-dialog title="User Information" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="form" label-width="100px" style="padding-right: 50px" :rules="rules" ref="formRef">
        ...
        <el-form-item label="Personal Info" prop="info">
